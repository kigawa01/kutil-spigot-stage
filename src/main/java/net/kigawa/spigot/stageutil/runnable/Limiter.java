package net.kigawa.spigot.stageutil.runnable;

import net.kigawa.spigot.pluginutil.PluginBase;
import net.kigawa.spigot.stageutil.StageData;
...
public class Limiter extends BukkitRunnable {
    ...
    public Limiter(PluginBase kigawaPlugin, List<Player> players, StageData stageData) {
        plugin = kigawaPlugin;
